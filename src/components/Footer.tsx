...
export default function Footer({ setCurrentPage }: FooterProps) {
  ...
  return (
    <footer className="bg-zinc-150/70 border-t border-border-soft w-full py-16 mt-auto">
      ...
      <div className="mt-12 pt-8 border-t border-zinc-200 text-center font-nunito text-xs text-zinc-450 max-w-container-max mx-auto px-gutter space-y-2">
        <div>© 2026 MAXFMS Facility Management Services. All rights reserved.</div>
        <div>
          Project by-{' '}
          <a
            href="https://wa.me/7207667827"
            target="_blank"
