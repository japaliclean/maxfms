...
export default function BookingWizard({
  ...
  const progressBarWidthClass: Record<number, string> = {
    1: 'w-[25%]',
    2: 'w-[50%]',
    3: 'w-[75%]',
    4: 'w-[100%]',
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden border border-border-soft animate-slide-up relative flex flex-col max-h-[90vh]">
        ...
        {!isDone && (
          <div className="w-full bg-zinc-100 h-1.5 shrink-0 flex">
            <div className={`bg-primary h-full transition-all duration-300 ${progressBarWidthClass[step]}`} />
          </div>
        )}
            ...
            <div className="animate-fade-in">
              ...
              {step === 2 && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="booking-date" className="block text-xs font-bold font-hanken text-zinc-600 block mb-2 uppercase tracking-wide">
                    ...
                    <div>
                      <label htmlFor="booking-time" className="block text-xs font-bold font-hanken text-zinc-600 block mb-2 uppercase tracking-wide">
                        Appointment Slot
                      </label>
                      <select
                        id="booking-time"
              ...
              {step === 3 && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="booking-first-name" className="block text-xs font-bold font-hanken text-zinc-650 mb-2 uppercase tracking-wide">
                        First Name
                      </label>
                      <input
                    ...
                    <div>
                      <label htmlFor="booking-last-name" className="block text-xs font-bold font-hanken text-zinc-650 mb-2 uppercase tracking-wide">
                        Last Name
                      </label>
                      <input
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="booking-email" className="block text-xs font-bold font-hanken text-zinc-650 mb-2 uppercase tracking-wide">
                        Email Address
                      </label>
                      <input
                        id="booking-email"
                    ...
                    <div>
                      <label htmlFor="booking-phone" className="block text-xs font-bold font-hanken text-zinc-650 mb-2 uppercase tracking-wide">
                        Phone Number
                      </label>
                      <input
                        id="booking-phone"
