          ...
          >
            ...
            >
              <button
                ...
                className="relative group inline-flex items-center gap-2 text-sm font-bold font-hanken text-white bg-blue-600 hover:bg-blue-700 transition-colors rounded-full px-5 py-3 shadow-md cursor-pointer tracking-wider uppercase"
              >
                <span>Products</span>
            ...
            >
              <button
                ...
                className="relative group inline-flex items-center gap-2 text-sm font-bold font-hanken text-white bg-orange-500 hover:bg-orange-600 transition-colors rounded-full px-5 py-3 shadow-md cursor-pointer tracking-wider uppercase"
              >
                <span>Services</span>
                <ArrowUpRight className="w-4 h-4 text-white group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                ...
                {heroCards.map((card, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`col-span-2 sm:col-span-1 self-end transition-all duration-500 ease-out cursor-pointer hover:scale-105 ${isActive ? 'scale-[1.15] rotate-0 translate-y-0 z-[40]' : transformClass} ${isAnyActive && !isActive ? 'blur-sm opacity-40' : 'opacity-100 z-[10]'}`}
                    >
